    ...
    render() {
        return (
            <div className="item" style={{ height: this.props.mini ? "220px" : "320px", width: this.props.mini ? "170px" : "220px" }} onClick={() => {
                ...
                <div style={{ color: "gray", float: "left", margin: 10, fontSize: 16 }}>Ціна: {this.props.item.price} $</div>
                <div style={{ color: "gray", float: "right", margin: 10, fontSize: 13 }}>{this.props.item.popular && "Популярне"}</div>
