            ...
            <div>
                <Dialog
                    ...
                    <div style={{ display: "flex", marginTop: 25 }}>
                        ...
                        <div style={{ marginTop: 10, marginLeft: 10, fontSize: 16, color: "gray" }}>Продукти в корзині  </div>
                    </div>
                    ...
                    <div style={{ marginTop: 20 }}>
                        <div style={{ float: "left", margin: 10, marginTop: 20, fontSize: 20, color: "gray", fontWeight: "bold" }}> Загальна ціна: {totalPrice} $</div>
