                ...
                <div className="product-list-header">
                    ...
                    <div style={{ width: 500, marginTop: 5, display: "flex", flexGrow: 1, flexDirection: "row-reverse" }}>
                        ...
                        <div style={{ width: 250 }}>
                            <Dropdown
                                options={[
                                    { value: 'lh', label: 'З меншої до більшої' },
                                    { value: 'hl', label: 'З більшої до меншої' },
                                ]}
                        ...
                        {this.getParamFromURL("usePriceFilter") &&
                            <Tooltip title="Натисніть щоб змінити діапазон" disableFocusListener >
                                <Button
                                    variant="outlined"
