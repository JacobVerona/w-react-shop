            ...
            <div className="details-page">
                ...
                <div className="details-page-content">
                    ...
                    <div style={{ flex: 1, marginLeft: 30, display: "flex", flexDirection: "column" }}>
                        <div style={{ flex: 1 }}>
                            <div style={{ fontSize: 20, fontWeight: "bold", color: "#4282ad" }}>Ціна: {this.state.item.price} $</div>
                            {this.state.item.inStock ?
                                <span style={{ color: "#0a7f19", marginTop: 5, fontSize: 14 }}>В наявності</span> :
                                <span style={{ color: "red", marginTop: 5, fontSize: 14 }}>Не в наявності</span>}
                            {this.state.item.popular && <span style={{ marginTop: 5, color: "gray", fontSize: 14 }}> | Популярне</span>}
                        ...
                        <div style={{ fontWeight: "bold", fontSize: 16 }}>Опис</div>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                    <div className="online-shop-title-smaller">Схожі товари {this.state.relatedItems.length === 0 ? "(N/A)" : ""}</div>
